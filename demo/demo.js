...
function drawSky(mvp) {
    ...
    var program = webglUtils.createProgramFromScripts(gl, ["vertex-shader-sky", "fragment-shader-sky"]);
    ...
    gl.bindTexture(gl.TEXTURE_CUBE_MAP, textureSky);
